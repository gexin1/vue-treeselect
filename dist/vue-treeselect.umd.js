...
/* harmony default export */ var treeselectMixin = ({
  ...
  methods: {
    ...
    select: function select(node) {
      ...
      var nodeState = this.forest.checkedStateMap[node.id];
      var nextState = this.multiple && !this.flat ? nodeState === UNCHECKED || nodeState === INDETERMINATE : !this.isSelected(node);
      if (nextState) {
